export default {
  ...
  home: {
    eyebrow: 'BeatPioneer',
    title: 'Willkommen bei BeatPioneer',
    subtitle: '',
    intro: [
      'Du machst Musik. Du trägst einen Sound in dir, der nach Form und Richtung sucht. Du brauchst keinen weiteren Kurs, der verspricht, dich zur Ikone zu machen. Du brauchst jemanden, der deinen Track wirklich hört und dir hilft, ihn echt zu bauen.',
      'Ich arbeite mit dir in der Pre-Produktion. Künstlerische Leitung, Entwicklung deiner musikalischen Identität, klangliche Entscheidungen, Live-Strategie, der Weg, der aus einer Idee ein tragfähiges Projekt macht.',
      'Nicht um allen zu gefallen, sondern um die Menschen zu finden, die wirklich zuhören. Die mit dem mitschwingen, was du machst.',
      'Wenn du etwas Echtes bauen willst, einen Track, eine Identität, ein Projekt, dann ist BeatPioneer der Ort. Hier fängt es an. Ich bin OBNM.',
    ],
  },
  bio: {
    eyebrow: 'Bio',
    ...
    items: [
      {
        ...
        quote: 'Ich habe Oscar während meines 6-monatigen Aufenthalts in Hamburg kennengelernt. Ich brauchte neue Anreize und beschloss, an den X-Factor Auditions teilzunehmen. Oscar stellte mir sein Heimstudio und sein Fachwissen vollständig zur Verfügung. Dank ihm lernte ich eine effektive Arbeitsmethode, die mir den Weg zu den X-Factor Bootcamps ermöglichte. Oscars beste Eigenschaften sind Entschlossenheit und Methodik. Ich empfehle ihn nicht nur wegen seiner Professionalität, sondern auch wegen seiner menschlichen Seite.',
      },
      {
        name: 'DavideGSax',
        role: 'Musiker, Performer',
        photo: '/assets/DavideGSax2.png',
        quote: 'Meine künstlerische Zusammenarbeit mit Oscar dauert schon viele Jahre an. Seine Erfahrung und seine Fähigkeit zuzuhören waren mir in meiner Karriere eine große Hilfe. Er hat mir wertvolle musikalische Ratschläge gegeben und mich beim Mix einer der Songs meines neuesten Werks unterstützt. Er hat auch meine Live-Auftritte aufmerksam verfolgt und gezielte Empfehlungen zur Performance, Bühneninszenierung und Außenwirkung gegeben.',
      },
      {
        name: 'Samuele Longo',
        role: 'Sänger, Songwriter',
        photo: '/assets/SamueleLongo.png',
        quote: 'Oscar war während meines gesamten Projekts ein Mentor und ein wertvoller Freund. Seine Fähigkeit, eine ruhige und kooperative Arbeitsumgebung zu schaffen, hat es mir ermöglicht, meine Kreativität bestmöglich auszudrücken. Dank seiner technischen Fähigkeiten und seiner außergewöhnlichen künstlerischen Sensibilität haben wir ein Arrangement für eines meiner Lieder geschaffen, das all meine Erwartungen übertroffen hat.',
      },
      {
        name: 'Carnival Corpse',
        role: 'Sänger, Songwriter',
        photo: '/assets/Carnival-Corps.jpg',
        quote: 'Empfehlung an alle Künstler, die nach einem aufgeschlossenen, kreativen Produzenten suchen! Mit Oscar verbinde ich ehrliche Kommunikation, klare Struktur, Zuverlässigkeit und ein sehr freundliches Wesen. Beim Recording meines Songs "Mutter Erde" habe ich einen starken Unterstützer gefunden, der mit eigenen Ideen überzeugt und gleichzeitig offen für die Vorstellungen des Künstlers ist. So sind zwei Versionen des Songs entstanden, eine Live-nahe und eine BeatPioneer Version, in der wir der gemeinsamen Kreativität freien Lauf lassen konnten.',
      },
    ],
  },
  contact: {
    ...
    body: 'Schreib mir, wenn du verstehen möchtest, wie ich arbeite, mir dein Projekt erzählen oder eine Form der Zusammenarbeit finden willst.',
